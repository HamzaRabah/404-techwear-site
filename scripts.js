    ...
    products.forEach(product => {
        ...
        if (product.status === 'available') {
            productHTML += `
                ...
                <a href="https://wa.me/+963935776387?text=I'm%20interested%20in%20ordering%20the%20'${encodeURIComponent(product.name)}'%20t-shirt%20in%20${product.defaultColor}" class="btn btn-outline whatsapp-btn" target="_blank">
